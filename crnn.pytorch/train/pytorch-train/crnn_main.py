...
parser.add_argument(
    '--trainroot', help='path to dataset', default='/HomeWork/CHINESE-OCR/train/data/lmdb/train')
parser.add_argument(
    '--valroot', help='path to dataset', default='/HomeWork/CHINESE-OCR/train/data/lmdb/val')
parser.add_argument(
...
parser.add_argument(
    ...
    default=
    '/HomeWork/CHINESE-OCR/save_model/newest.pth'
)
