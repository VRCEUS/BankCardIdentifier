# -*- coding:utf-8 -*-
import numpy as np
from text_detection_ctpn.utils.bbox.nms import nms

from text_detection_ctpn.utils.bbox.bbox_transform import bbox_transform_inv, clip_boxes
from text_detection_ctpn.utils.rpn_msr.config import Config as cfg
from text_detection_ctpn.utils.rpn_msr.generate_anchors import generate_anchors
