...
from text_detection_ctpn.utils.text_connector.other import Graph
from text_detection_ctpn.utils.text_connector.text_connect_cfg import Config as TextLineCfg
